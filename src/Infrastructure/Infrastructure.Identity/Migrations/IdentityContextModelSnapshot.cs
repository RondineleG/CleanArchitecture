...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity(
            "Application.DTOs.Account.RefreshToken",
            b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
        ...
        modelBuilder.Entity(
            "Infrastructure.Identity.Models.ApplicationUser",
            b =>
            {
        ...
        modelBuilder.Entity(
            "Application.DTOs.Account.RefreshToken",
            b => b.HasOne("Infrastructure.Identity.Models.ApplicationUser", null)
                .WithMany("RefreshTokens")
                .HasForeignKey("ApplicationUserId"));

        modelBuilder.Entity(
            "Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>",
            b => b.HasOne("Microsoft.AspNetCore.Identity.IdentityRole", null)
                .WithMany()
        ...
        modelBuilder.Entity("Infrastructure.Identity.Models.ApplicationUser", b => b.Navigation("RefreshTokens"));
